...
document.addEventListener('keydown', function(e) {
    ...
    if (e.ctrlKey && e.key === 's') {
        e.preventDefault();
        saveCart();
        showNotification('购物车已保存', 'success');
    }
...
console.log('智能购物系统客户端已加载完成');
console.log('快捷键说明:');
console.log('Ctrl+K - 启动摄像头识别');
console.log('Ctrl+S - 保存购物车');
console.log('Ctrl+D - 清空购物车');
console.log('Ctrl+P - 快速结算');